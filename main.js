...
const tempCard = (val, unit = "cel") => { 
  ...
  <h6 class="card-subtitle mb2">${val.temp}${flag}</h6>
...
const getLoader = () => {
  return `<div class="centered-loader spinner-grow text-info" role="status">
...
document.addEventListener('DOMContentLoaded', async() => {
  ...
  countriesListDropDown.addEventListener ("change",async function () {
    ...
    let statesOptions = "";
  if(states){
    statesOptions += `<option value="">States</option>`;
